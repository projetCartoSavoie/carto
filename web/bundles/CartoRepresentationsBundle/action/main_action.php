<?php
	if (isset($_POST['search'])){
		$cmd = $_POST['search'];
		//$options = //liste des relations à prendre en compte (all si aucune relation sélectionnée)
		$options = 'all';
	}
	else { $cmd = 'entity'; }
	...
	curl_setopt($curlSession, CURLOPT_URL, 'http://carto.localhost/fr/donnees/json/'.$cmd.'/'.$options); //Céline  // .'/'.$options = rel1,rel2,rel3
